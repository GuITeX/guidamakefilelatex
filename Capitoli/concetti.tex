...
sintassi
\begin{sintassi}
  \small \meta{variabile} \texttt{=} \meta{valore}
\end{sintassi}
...
file.\footnote{Per un elenco esaustivo di queste funzioni vedi
  \cite[pagina 83]{gnu:make}.}  Fra tutte ne ricordiamo una:
\begin{sintassi}
...
stringhe.\footnote{Per un elenco esaustivo di queste funzioni vedi
  \cite[pagina 80]{gnu:make}.}  In particolare la funzione
\begin{sintassi}
...
\begin{sintassi}
  \small \texttt{\textcolor{blue}{\textbf{for}}} \meta{variabile} in
